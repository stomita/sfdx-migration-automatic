...
sfdx-migration-automatic/1.4.1 darwin-x64 node-v8.14.0
...
_See code: [src/commands/automig/dump.ts](https://github.com/stomita/sfdx-migration-automatic/blob/v1.4.1/src/commands/automig/dump.ts)_
...
_See code: [src/commands/automig/load.ts](https://github.com/stomita/sfdx-migration-automatic/blob/v1.4.1/src/commands/automig/load.ts)_
<!-- commandsstop -->
